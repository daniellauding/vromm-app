-- Map Presets Schema - FIXED VERSION
-- This file contains the complete database schema for the map presets feature
-- Run this to fix the "relation map_preset_members does not exist" error
...
-- RLS Policies for map_presets (must come first since other policies reference this table)
