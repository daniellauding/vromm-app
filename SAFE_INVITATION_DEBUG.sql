-- SAFE INVITATION DEBUG - No enum errors
-- Run this to get a quick overview without errors
...
-- ============================================================================
-- 10. NOTIFICATION TYPES BREAKDOWN (Safe version)
-- ============================================================================
SELECT 
    ...
    CASE 
        ...
        WHEN type = 'system' THEN '⚙️ System notifications'
