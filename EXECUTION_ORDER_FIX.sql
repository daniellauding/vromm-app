-- EXECUTION ORDER FIX
-- Run these commands in EXACTLY this order to fix all issues

-- ==============================================
-- STEP 1: FIX DUPLICATE TRANSLATIONS FIRST
-- ==============================================
...
-- ==============================================
-- STEP 2: CREATE MAP PRESETS SCHEMA
-- ==============================================
...
-- ==============================================
-- STEP 3: NOW ADD TRANSLATIONS (FIXED VERSION)
-- ==============================================

-- Map Presets English Translations (FIXED - no duplicate keys)
...
-- Map Presets Swedish Translations (FIXED - no duplicate keys)
INSERT INTO translations (key, value, language, platform) VALUES
