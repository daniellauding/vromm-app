-- Collection Sharing Schema Updates
-- Add allow_public_edit column to map_presets table and update translations

-- 1. Add allow_public_edit column to map_presets table
...
-- 3. Update existing public collections to have allow_public_edit = false by default
UPDATE map_presets 
SET allow_public_edit = FALSE 
WHERE visibility = 'public' AND allow_public_edit IS NULL;

-- 4. Insert Collection Sharing Translations (English)
...
-- 5. Insert Collection Sharing Translations (Swedish)
INSERT INTO translations (id, key, language, value, platform, created_at, updated_at) VALUES
...
-- 6. Insert Collection Members Translations (English)
INSERT INTO translations (id, key, language, value, platform, created_at, updated_at) VALUES
...
-- 7. Insert Collection Members Translations (Swedish)
INSERT INTO translations (id, key, language, value, platform, created_at, updated_at) VALUES
...
-- 8. Insert additional translations for public edit permissions
INSERT INTO translations (id, key, language, value, platform, created_at, updated_at) VALUES
...
-- 10. Check translations were inserted
SELECT COUNT(*) as translation_count 
FROM translations 
WHERE key LIKE 'collectionSharing.%' OR key LIKE 'collectionMembers.%' OR key LIKE 'roleManagement.%' OR key LIKE 'routeCollections.allowPublicEdit%';
