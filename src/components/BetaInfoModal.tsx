...
export const BetaInfoModal: React.FC<BetaInfoModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <SafeAreaView
        style={{ flex: 1, backgroundColor: colorScheme === 'dark' ? '#0F0F0F' : '#FFFFFF' }}
      >
        {/* Header with Close */}
            ...
            <YStack gap="$4">
              ...
              >
                <YStack gap="$3">
                  ...
                  <Text
                    fontSize="$4"
                    color={colorScheme === 'dark' ? '#D1D5DB' : '#475569'}
                    lineHeight={22}
                  >
                  ...
                  <YStack gap="$3">
                    ...
                    >
                      <Text color="white" fontWeight="600" textAlign="center">
                        ...
                        https://play.google.com/apps/internaltest/4700291677340932601
                      </Text>
                    </TouchableOpacity>
                  </YStack>
                </YStack>
