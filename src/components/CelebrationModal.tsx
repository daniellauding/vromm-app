  ...
  const getMotivationalMessage = () => {
    if (completionPercentage === 100) {
      return {
        ...
        message: t('celebration.pathCompleted.message') || 'Amazing work! You\'ve mastered this learning path.',
        icon: 'trophy',
        color: '#FFD700',
      };
        ...
        {[...Array(20)].map((_, i) => (
          <Animated.View
            ...
            style={{
              ...
              width: 8,
              height: 8,
              backgroundColor: ['#FFD700', '#FF6B35', '#4B6BFF', '#00E6C3'][Math.floor(Math.random() * 4)],
              borderRadius: 4,
              transform: [
                {
            ...
            >
              ...
              <YStack gap="$2">
                ...
                <Text fontSize="$2" color="$gray11" textAlign="center">
                  {completedExercises} / {totalExercises} {t('celebration.exercisesCompleted') || 'exercises completed'}
                </Text>
              </YStack>
