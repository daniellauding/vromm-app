...
export function RouteWizardSheet({ onCreateRoute, onMaximize }: RouteWizardSheetProps) {
  ...
  const swipeGesture = Gesture.Pan()
    ...
    .onEnd((event) => {
      ...
      console.log('🧙‍♂️ Swipe gesture detected:', { translationX, velocityX, currentStepIndex, stepsLength: steps.length });
      ...
      if (hasSignificantVelocity || hasSignificantDistance) {
        if (translationX < 0 && currentStepIndex < steps.length - 1) {
          ...
          console.log('🧙‍♂️ Swipe left - next step from', currentStepIndex, 'to', currentStepIndex + 1);
          runOnJS(handleNext)();
        } else if (translationX > 0 && currentStepIndex > 0) {
          // Swipe right - previous step
          console.log('🧙‍♂️ Swipe right - previous step from', currentStepIndex, 'to', currentStepIndex - 1);
          runOnJS(handleBack)();
        }
      }
    });
  ...
  const canProceed = useCallback(() => {
    ...
    switch (currentStep) {
      ...
      case 'exercises':
        ...
        console.log('🧙‍♂️ canProceed (exercises):', result, 'exercises count:', routeData.exercises.length);
        break;
  ...
  const hasUserData = useCallback(() => {
    ...
    const result = hasWaypoints || hasName || hasDescription || hasRoutePath || hasPenPath || hasExercises || hasMedia;
  ...
  const getStepTitle = (step: WizardStep) => {
    switch (step) {
      ...
      case 'basic': return 'Name & Details';
      case 'exercises': return 'Add Exercises';
      default: return '';
    }
  };
        ...
        case 'map':
          ...
          return (
            <View style={{ flex: 1 }}>
              ...
              <View style={{ paddingHorizontal: 16, paddingVertical: 12, backgroundColor: DARK_THEME.background }}>
              ...
              <View style={{ paddingHorizontal: 16, paddingTop: 8, paddingBottom: 16 }}>
                <XStack gap="$2" justifyContent="space-between" alignItems="center">
                  ...
                  >
                    <XStack gap="$1" alignItems="center">
                      <Text color={canProceed() ? "black" : "$gray10"} fontWeight="600">Next</Text>
                      <Feather name="arrow-right" size={16} color={canProceed() ? "black" : "#666"} />
                    </XStack>
                  </Button>
                </XStack>
              </View>
              ...
              <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
                <XStack gap="$2" justifyContent="space-between" alignItems="center">
                  ...
                  >
                    <XStack gap="$1" alignItems="center">
                      <Feather name="arrow-left" size={16} color="$gray11" />
                      <Text color="$gray11" fontWeight="600">Previous</Text>
                    </XStack>
                  </Button>
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
                <XStack gap="$2" justifyContent="space-between" alignItems="center">
                  ...
                  >
                    <XStack gap="$1" alignItems="center">
                      <Text color="black" fontWeight="600">Publish</Text>
                ...
                <Button
                  ...
                  width="100%"
                >
                  <Text color="$gray11" fontWeight="500">Save as Draft</Text>
                </Button>
              </View>
            </View>
          );
          ...
          {isRecording && (
            <View style={styles.handleContainer}>
              ...
              <XStack alignItems="center" justifyContent="space-between" width="100%" paddingHorizontal="$2">
                ...
                <TouchableOpacity 
                  onPress={() => {
                    console.log('🧙‍♂️ X button pressed during recording - stopping recording first');
                    stopRecording();
