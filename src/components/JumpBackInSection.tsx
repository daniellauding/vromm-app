    ...
    try {
      ...
      virtualCompletions?.forEach((virtual: any) => {
        ...
        if (exerciseMap.has(exerciseId)) {
          ...
          exerciseData.completed_repeats += 1;
          exerciseData.progress_percent =
            exerciseData.completed_repeats / exerciseData.total_repeats;
    ...
    <>
      ...
      {showExerciseSheet && selectedLearningPathId && (
        <ExerciseListSheet
          ...
          title={
            recentExercises.find((ex) => ex.learning_path_id === selectedLearningPathId)
              ?.learning_path_title[lang] ||
            recentExercises.find((ex) => ex.learning_path_id === selectedLearningPathId)
              ?.learning_path_title.en ||
            'Learning Path'
          }
