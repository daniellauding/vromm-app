  ...
  const handleRoleSelect = async (role: UserRole) => {
    ...
    try {
      ...
      if (error) {
        ...
        Alert.alert(
          'Error',
          'Could not update your role. Please try again later.'
        );
      } else {
    ...
    <Screen>
      ...
      <YStack padding="$4" space="$4">
        ...
        <Text color="$gray11" marginTop="$2">
          Välj den roll som passar dig bäst. Detta hjälper oss att anpassa applikationen efter dina behov.
        </Text>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', width: '100%' }}>
                  <View style={{ 
                    ...
                    <Feather name={roleOption.icon} size={24} color={isSelected ? '#000' : '#555'} />
                  </View>
                  <View style={{ flex: 1 }}>
                    <Text weight="bold" size="lg">{roleOption.title}</Text>
                    <Text color="$gray11" size="sm">{roleOption.description}</Text>
                  </View>
                  {isSelected && (
                    <View style={{
      ...
      >
        ...
        >
          ...
          >
            <Text weight="bold" size="xl" marginBottom="$2">Organisation</Text>
            <Text marginBottom="$4">När du väljer rollen Trafikskola behöver du ange organisationsnummer.</Text>
