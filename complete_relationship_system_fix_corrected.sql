-- COMPLETE FIX: Create all missing tables and relationships system (CORRECTED)
...
DROP POLICY IF EXISTS "Users can view their own relationships" ON supervisor_student_relationships;
...
DROP POLICY IF EXISTS "Users can create relationships they are part of" ON supervisor_student_relationships;
...
DROP POLICY IF EXISTS "Users can view reviews they are involved in" ON relationship_reviews;
DROP POLICY IF EXISTS "Users can create reviews for their relationships" ON relationship_reviews;
DROP POLICY IF EXISTS "Users can update their own reviews" ON relationship_reviews;
DROP POLICY IF EXISTS "Users can delete their own reviews" ON relationship_reviews;
DROP POLICY IF EXISTS "Admins can manage all reviews" ON relationship_reviews;
...
-- Users can create reviews for relationships they are part of (FIXED - removed NEW reference)
