-- Fix Collection Invitations System (CORRECTED)
...
CHECK (role IN ('student', 'instructor', 'teacher', 'admin', 'collection_sharing'));
...
-- 11. Update existing collection invitations to have proper type
UPDATE pending_invitations 
