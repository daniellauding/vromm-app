-- Fix RLS Policies for Map Presets System
...
-- 3. Create comprehensive RLS policies for map_presets
...
-- 4. Create comprehensive RLS policies for map_preset_members
...
-- 5. Create comprehensive RLS policies for map_preset_routes
...
-- 6. Add role column to map_preset_members if it doesn't exist
...
-- 12. Create view for collections with member count
CREATE OR REPLACE VIEW map_presets_with_counts AS
SELECT 
    mp.*,
